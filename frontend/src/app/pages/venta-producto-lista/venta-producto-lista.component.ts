...
@Component({
  selector: 'app-venta-producto-lista',
  templateUrl: './venta-producto-lista.component.html',
  styleUrls: ['./venta-producto-lista.component.css']
})
export class VentaProductoListaComponent implements OnInit, AfterViewInit, OnDestroy{
  ...
  eventOutput_buscar(element:any){
    ...
    this.listaProductoVentaBySucursalFechas();
  }
  ...
  listaProductoVentaBySucursalFechas() {
    ...
    this.ventaHttpService
      .listaProductoVentaBySucursalFechas(parametros)
      .subscribe((res) => {
        if (this.alertaSwalService.mostrarErrorHttp(res)) {
          return;
        }
